...
//
// ВАЖНО: после загрузки файла нужно ОДИН раз привязать вебхук — см. инструкцию в чате.

const TOKEN = process.env.TELEGRAM_BOT_TOKEN;

// ===== НАСТРОЙКИ — поменяйте ссылки под себя =====
const MINIAPP_URL  = "https://alliance16-06.vercel.app"; // адрес вашего мини-приложения
...
const SITE_URL     = "https://alliance-lawyer.ru/";      // сайт фирмы
